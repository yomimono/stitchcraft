...
let make_pattern font textcolor background gridsize phrases interline output =
...
let stitch font textcolor background gridsize phrase interline output =
  match (make_pattern font textcolor background gridsize phrase interline output) with
  | Ok () -> ()
